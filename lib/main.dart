...
//      home: TabScreen(),
      initialRoute: '/', //default to go to home page
      //key which identify screens
      routes: {
        '/': (ctx) => TabScreen(_favMeals), //same as home
        CategoryMealsScreen.routeName : (ctx) => CategoryMealsScreen(_availableMeals),
        CategoriesScreen.routeName : (ctx) => CategoriesScreen(),
        MealDetailScreen.routeName: (ctx) => MealDetailScreen(_toggleFav, _isMealFavorite),
